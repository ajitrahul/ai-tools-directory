...
const config = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        'primary': '#2dd4bf', 'primary-focus': '#5eead4', 'secondary': '#1f2937',
        'background': '#0f172a', 'glass': 'rgba(255, 255, 255, 0.03)',
        'glass-border': 'rgba(255, 255, 255, 0.1)', 'text-main': '#e2e8f0',
      ...
      animation: {
        ...
        "aurora": "aurora 20s ease infinite", "fade-in": 'fadeIn 0.5s ease-in-out',
      },
      backgroundImage: {
